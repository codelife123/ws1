...
export default function GallerySectionClient({ slidesPerView = 3, grid = false }) {
        ...
        {grid ? (
          ...
          <>
            ...
            <div className="mt-8 flex justify-center">
              <a
                href="/gallery"
                className="inline-block bg-[color:var(--color-accent)] text-[color:var(--color-primary)] px-8 py-3 rounded-lg font-semibold shadow hover:bg-[color:var(--color-accent-dark)] hover:scale-105 transition-all duration-200"
              >
                See more
              </a>
            </div>
